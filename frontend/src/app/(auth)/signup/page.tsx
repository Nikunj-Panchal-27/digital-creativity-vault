      ...
      <Card className="border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-xl text-zinc-900 dark:text-zinc-100 shadow-2xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-zinc-500 dark:text-zinc-400">
            Join Digital Creativity Vault to start designing
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-4 mb-6">
            <Button variant="outline" className="border-zinc-700 bg-zinc-800/50 hover:bg-zinc-700 text-zinc-300">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="John Doe" className="bg-white dark:bg-zinc-800/50 border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100" {...field} />
                    </FormControl>
